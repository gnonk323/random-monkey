      ...
      <main className="flex flex-col gap-6 items-center justify-center h-screen px-4 py-16">
        <div className="h-full flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              className="flex items-center gap-2 px-3 py-2 h-full rounded-lg text-white bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:cursor-default transition-all font-extrabold cursor-pointer text-sm md:text-base"
